...
def parse():
    ...
    parser.add_argument('--attack_dataset', type=str, default="nq-train", help='BEIR dataset to evaluate,  nq, nq-train, msmarco fiqa hotpotqa scifact')
    parser.add_argument('--split', type=str, default='test',help='train, test') # Use the query of the training set to generate clusters, and then use the generated documents to attack
    parser.add_argument('--attack_model_code', type=str, default='contriever-msmarco',help='contriever, contriever-msmarco, dpr-single, dpr-multi,ance bge_m3 qwen3 bge_reasoner gte diver linq reasonir')
    ...
    parser.add_argument("--eval_model_code", type=str, default="contriever-msmarco", choices=["contriever-msmarco", "contriever", "dpr-single", "dpr-multi", "ance", 'tas-b','dragon','condenser'])
